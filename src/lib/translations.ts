export const translations = {
      en: {
        ...
        faq: {
          ...
          q1: 'Since your platform is cloud-based, how secure is our transaction data and vendor information on HUNTR?',
          a1: 'Security is our top priority. HUNTR uses end-to-end data encryption and an advanced cloud infrastructure with layered security protocols. We ensure that all sensitive data between buyers and sellers is isolated and only accessible by authorized parties, keeping your business integrity intact 24/7.',
          q2: 'What makes HUNTR different from other e-procurement platforms or B2B marketplaces?',
          a2: 'Our main differentiator is our integrated Strategic Sourcing Technology. We are not just a product listing directory, but an ecosystem that integrates the entire demand and supply chain. We focus on process efficiency—ensuring the best match between buyers and sellers automatically on a single platform accessible anytime.',
          q3: 'How long does it take for our company to start using HUNTR?',
          a3: "We designed HUNTR with an intuitive interface, making the onboarding process very fast. Being cloud-based, there's no complicated hardware installation. Your company can be integrated and operating on our platform in a matter of days, not weeks.",
      ...
      id: {
        ...
        faq: {
          ...
          q1: 'Karena platform Anda berbasis cloud, seberapa aman data transaksi dan informasi vendor kami di HUNTR?',
          a1: 'Keamanan adalah prioritas utama kami. HUNTR menggunakan enkripsi data end-to-end dan infrastruktur cloud tingkat lanjut dengan protokol keamanan berlapis. Kami memastikan bahwa setiap data sensitif antara pembeli dan penjual terisolasi dan hanya dapat diakses oleh pihak berwenang, sehingga integritas bisnis Anda tetap terjaga 24/7.',
          q2: 'Apa bedanya HUNTR dengan platform e-procurement atau marketplace B2B lainnya?',
          a2: 'Perbedaan utama kami terletak pada Teknologi Strategic Sourcing yang terintegrasi. Kami bukan sekadar direktori daftar barang, melainkan ekosistem yang mengintegrasikan seluruh rantai demand dan supply. Kami berfokus pada efisiensi proses—memastikan kecocokan terbaik antara pembeli dan penjual secara otomatis dalam satu platform yang bisa diakses kapan saja.',
          q3: 'Berapa lama waktu yang dibutuhkan bagi perusahaan kami untuk mulai menggunakan HUNTR?',
          a3: 'Kami mendesain HUNTR agar memiliki antarmuka yang intuitif sehingga proses onboarding sangat cepat. Karena berbasis cloud, tidak ada instalasi perangkat keras yang rumit. Perusahaan Anda bisa mulai terintegrasi dan beroperasi di platform kami dalam hitungan hari, bukan minggu.',
